...
public class Transaction
{
	...
	[JsonIgnore] [DefaultValue(false)] public bool TriedToPay { get; set; }

	[JsonIgnore] public bool IsSucceed { get; set; }

	[JsonIgnore] public string Tran_Ref { get; set; }

	[JsonIgnore] public bool IsValid_Signature { get; set; }
	...
	[JsonIgnore] public string ServerKey { get; set; }
