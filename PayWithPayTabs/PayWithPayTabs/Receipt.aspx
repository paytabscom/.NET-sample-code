            ...
            <div id="page-wrap">
                ...
                <div id="identity">
                    ...
                    <div id="address">
                        ...
                        Business Bay Building,No. 1260, Road No. 2421,
                        <br />
                        Juffair, Al Fateh<br />
                        Kingdom of Bahrain
                    </div>
                ...
                <div id="customer">
                    <div id="customer-title">
                        ...
                        <br />
                        <br />
                        <b>Card Type:</b><asp:Label runat="server" ID="lblCardType"></asp:Label><div style="margin-top: -24px; margin-left: 80px;">
                            <img id="cardType" src="Content/Images/visa.png" alt="card" runat="server" />
                        </div>
                        <br />
                    ...
                    <table id="meta">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Label runat="server" ID="lblTransactionDate"></asp:Label></td>
                            </tr>
                            <tr>
                                <td class="meta-head">Amount Due</td>
                                <td>
                                    <asp:Label runat="server" ID="lblAmountDue"></asp:Label></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr class="item-row">
                            ...
                            <td class="description">
                                <asp:Label runat="server" ID="lblProduct"></asp:Label></td>
                            <td>
                                <div class="cost">
                            ...
                            <td><span class="price">
                                <asp:Label runat="server" ID="lblAmount"></asp:Label></span></td>
                        </tr>
                        <tr>
                ...
                <div id="terms">
                    ...
                    Message :
                    <img id="imgMessage" src=".." alt="logo" style="width: 24px; height: 24px;" runat="server" />
